                        ...
                        <div className="author-profile flex">
                            ...
                            <div className="widget-social style-3">
                                <ul>
                                    ...
                                    <li className="style-2"><Link href="#"><i className="fab fa-telegram-plane"></i></Link></li>
                                    <li><Link href="#"><i className="fab fa-youtube"></i></Link></li>
                                    <li className="mgr-none"><Link href="#"><i className="icon-fl-tik-tok-2"></i></Link></li>
                                </ul>
                                <div className="btn-profile"><Link href="/login" className="sc-button style-1 follow">Follow</Link></div>
                            </div>
                        </div>
                        <Tabs>
                            <TabList>
                                            ...
                                            <TabPanel key={index}>
                                                        ...
                                                        <div key={index} className="col-xl-3 col-lg-4 col-md-6 col-12">
                                                            <div className="sc-card-product explode ">
                                                                <div className="card-media">
                                                                    <Link href="/item-details-01"><img src={data.img} alt="Axies" /></Link>
                                                                    ...
                                                                    <Link href="/login" className="wishlist-button heart"><span className="number-like"> {data.wishlist}</span></Link>
                                                                </div>
                                                                <div className="card-title mg-bt-16">
                                                                    <h5><Link href="/item-details-01">"{data.title}"</Link></h5>
                                                                </div>
                                                                <div className="meta-info">
                                                                    <div className="author">
                                                                        ...
                                                                        <div className="info">
                                                                            <span>Creator</span>
                                                                            <h6> <Link href="/author-02">{data.nameAuthor}</Link> </h6>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="card-bottom style-explode">
                                                                    ...
                                                                    <Link href="/activity-01" className="view-history reload">View History</Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ))
                                                }
                                                {
                                                    ...
                                                    <div className="col-md-12 wrap-inner load-more text-center"> 
                                                        <Link href="#" id="load-more" className="sc-button loadmore fl-button pri-3" onClick={showMoreItems}><span>Load More</span></Link>
                                                    </div>
                                                }
                                            </TabPanel>
                                        ))
