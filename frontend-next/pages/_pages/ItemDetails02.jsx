                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="content-right">
                                <div className="sc-item-details">
                                    ...
                                    <div className="client-infor sc-card-product">
                                        <div className="meta-info">
                                            <div className="author">
                                                ...
                                                <div className="info">
                                                    <span>Owned By</span>
                                                    <h6> <Link href="/author-02">Ralph Garraway</Link> </h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="meta-info">
                                    ...
                                    <Link href="/wallet-connect" className="sc-button loadmore style bag fl-button pri-3"><span>Place a bid</span></Link>
                                                                ...
                                                                <div className="client">
                                                                    <div className="sc-author-box style-2">
                                                                        ...
                                                                        <div className="author-infor">
                                                                            <div className="name">
                                                                                <h6><Link href="/author-02">{item.name} </Link></h6> <span> place a bid</span>
                                                                            </div>
                                                        ...
                                                        <div className="content">
                                                            <div className="client">
                                                                <div className="sc-author-box style-2">
                                                                    ...
                                                                    <div className="author-infor">
                                                                        <div className="name">
                                                                            <h6> <Link href="/author-02">Mason Woodward </Link></h6> <span> place a bid</span>
                                                                        </div>
