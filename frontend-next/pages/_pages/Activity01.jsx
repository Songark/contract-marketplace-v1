                        ...
                        <div className="col-lg-8 col-md-8 col-12">
                                ...
                                dataBox.slice(0,visible).map((item,index) =>(
                                    <div className="sc-card-activity style1" key={index}>
                                        <div className="content">
                                            ...
                                            <div className="infor">
                                                <h3> <Link href="/item-details-01">{item.title}</Link></h3>
                            ...
                            }
                            {
                                ...
                                <div className="col-md-12 wrap-inner load-more text-center"> 
                                    <Link href="#" id="load-more" className="sc-button loadmore fl-button pri-3 mt-10" onClick={showMoreItems}><span>Load More</span></Link>
                                </div>
                            }
                        </div>
                                    ...
                                    <ul className="box-check">
                                        {
                                            dataFilter.map((item,index) => (
                                                <li key={index}><Link href="#" className="box-widget-filter"><i className={item.icon}></i>{item.name}</Link></li>
                                            ))
                                        }
