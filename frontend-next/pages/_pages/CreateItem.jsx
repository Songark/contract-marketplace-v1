                         ...
                         <div className="col-xl-3 col-lg-6 col-md-6 col-12">
                            ...
                            <div className="sc-card-product">
                                <div className="card-media">
                                    <Link href="/item-details-01"><img src={img1} alt="Axies" /></Link>
                                    <Link href="/login" className="wishlist-button heart"><span className="number-like"> 100</span></Link>
                                ...
                                <div className="card-title">
                                    <h5><Link href="/item-details-01">"Cyber Doberman #766”</Link></h5>
                                ...
                                <div className="meta-info">
                                    <div className="author">
                                        ...
                                        <div className="info">
                                            <span>Owned By</span>
                                            <h6> <Link href="/author-02">Freddie Carpenter</Link></h6>
                                        </div>
                                    </div>
                                    <div className="price">
                                ...
                                <div className="card-bottom">
                                    <Link href="/wallet-connect" className="sc-button style bag fl-button pri-3"><span>Place Bid</span></Link>
                                                    ...
                                                    <div className="inner-row-form style-2">
                                                        <div className="seclect-box">
                                                            <div id="item-create" className="dropdown">
                                                                <Link href="#" className="btn-selector nolink">Abstraction</Link>
                                                                <ul >
                                                                    <li><span>Art</span></li>
