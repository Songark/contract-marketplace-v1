                            ...
                            <div className="inner-content">
                                ...
                                <div className="sc-widget style-1">
                                    ...
                                    <div className="widget widget-social style-2">
                                        ...
                                        <ul>
                                            <li><Link href="#" className="icon-fl-facebook"></Link></li>
                                            <li className="style-2"><Link href="#" className="icon-fl-coolicon"></Link></li>
                                            <li className="mgr-none"><Link href="#" className="icon-fl-mess"></Link></li>
                                        </ul>
                                    </div>
                                </div>    
                                ...
                                <ul>
                                    {
                                        dataRecent.map((item,index) => (
                                            <li key={index} className="box-recent-post">
                                                <div className="box-feature"><Link href="/blog-details"><img src={item.img} alt="Axies" /></Link></div>
                                                <div className="box-content">
                                                    <Link href="/blog-details" className="title-recent-post">{item.title}</Link>
                                                    <span><span className="sub-recent-post">{item.text}</span><Link href="/blog" className="day-recent-post">{item.time}</Link></span>
                                                </div>
                                            </li>
                                        ))
                                    }
                                ...
                                <ul>
                                    {
                                        dataTags.map((item,index) => (
                                            <li key={index}><Link href="/blog" className="box-widget-tag">{item.name}</Link></li>
                                        ))
                                    }
                                </ul>
                            </div>
