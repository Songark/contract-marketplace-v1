                            ...
                            <div className="wrap-heading flat-slider flex">
                                <div className="content">
                                    ...
                                    <div className="flat-bt-slider flex style2">
                                        <Link href="/explore-01" className="sc-button header-slider style style-1 rocket fl-button pri-1"><span>Explore
                                        </span></Link>
                                        <Link href="/create-item" className="sc-button header-slider style style-1 note fl-button pri-1"><span>Create
                                        </span></Link>
                                    </div>
                                </div>
                                <div className="image">
