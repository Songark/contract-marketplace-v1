...
const SliderStyle2 = () => {
    const subtitle = ''
    const title = 'Discover, find and sell extraordinary NFTs'
    const description = 'Marketplace for PlayEstates non fungible token NFTs'
    return (
                ...
                <div className="wrap-heading flat-slider d-flex align-items-center">
                    <div className="content">
                        ...
                        <div className="flat-bt-slider style2 flex">
                            <a href="/buy-sell" className="sc-button header-slider style style-1 note fl-button pri-1"><span>Buy Portfolios
                            </span></a>
                        </div>
                    </div>
                    ...
                    <Swiper
                        ...
                        speed= {2000}
                    >
                        <SwiperSlide><Image src={img1} alt="PlayEstates" /></SwiperSlide>
                        <SwiperSlide><Image src={img2} alt="PlayEstates" /></SwiperSlide>
                        <SwiperSlide><Image src={img3} alt="PlayEstates" /></SwiperSlide>
                        <SwiperSlide><Image src={img2} alt="PlayEstates" /></SwiperSlide>
                        <SwiperSlide><Image src={img3} alt="PlayEstates" /></SwiperSlide>
