                        ...
                        <div className="card-bottom">
                            <div className="author">
                                ...
                                <div className="content">
                                    <h4><Link href="/authors-01">{props.item.title}</Link></h4>
                                    <div className="infor">
                                        <span>Created by</span>
                                        <span className="name"><Link href="/authors-02">{props.item.name}</Link></span>
                                    </div>
                                </div>
                            </div>
                            <Link href="/login" className="wishlist-button public heart"><span className="number-like">{props.item.wishlist}</span></Link>
                        </div>
                    </div> 	
                </div>
            </div>
