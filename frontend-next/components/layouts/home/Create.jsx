    ...
    const data = [
        {
            ...
            description: "Once you’ve set up your wallet, connect it to PlayEstates by clicking the Wallet Connect button on the right top.",
            icon : icon1,
            colorbg : "icon-color1"
        },
        {
            title: "Buy NFTs",
            description: "Explore, find extraordinary NFTs listed and buy them.",
            icon : icon3,
            colorbg : "icon-color3",
        },
        {
    ...
    <div className='col-lg-4 col-md-4 col-12'>
        ...
        <div className="image center">
            <div className={`icon-create ${props.item.colorbg}`}>
                    <Image src={props.item.icon} alt="" />
                </div>                                                                           
            </div>
        <h3 className="heading"><Link href="/wallet-connect"><a>{props.item.title}</a></Link></h3>
