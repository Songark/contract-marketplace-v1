                        ...
                        <div className="col-md-12">
                            <div className="seclect-box style3">
                                ...
                                <div id="sort-by" className="dropdown style-2">
                                    <Link href="#"><a className="btn-selector nolink">Sort by</a></Link>
                                    <ul>
                                            ...
                                            <TabPanel key={data.id}>
                                                {
                                                    ...
                                                    <div key={item.id} className={`sc-card-product explode style2 mg-bt ${item.feature ? 'comingsoon' : '' } `}>                               
                                                        <div className="card-media">
                                                            ...
                                                            <Link href="/login"><a className="wishlist-button heart"><span className="number-like">{item.wishlist}</span></a></Link>
                                                        ...
                                                        <div className="card-bottom style-explode">
                                                            ...
                                                            <Link href="/activity-01"><a className="view-history reload">View History</a></Link>
                                                        </div>
                                                    </div>
                                                    ))
                                                }
