...
import logodark from '../../assets/images/logo/logo_footer_dark.png'
...
const Footer = () => {
    ...
    return (
        <div>
                                ...
                                <div className="logo-footer" id="logo-footer">
                                    <Link href="/">
                                        <a>
                                            ...
                                            <Image className='logo-light' id="logo_footer" src={logofooter} alt="nft-gaming" /> */}
                                            <Image id="logo_footer" src={logodark} alt="nft-gaming" />
                                        </a>
                                    </Link>
                                </div>
                                <p className="sub-widget-logo">We built a community where anyone can play great games, make new friends and earn real money.</p>
                            </div>
                        </div>
                                ...
                                <ul>
                                    {
                                        resourcesList.map((item,index) =>(
                                            <li key={index}><Link href={item.link}><a>{item.title}</a></Link></li>
                                        ))
                                    }
                                </ul>
                            </div>
                                    ...
                                    <ul>
                                        {
                                            socialList.map((item,index) =>(
                                                <li key={index}><Link href={item.link}><a><i className={item.icon}></i></a></Link></li>
                                            ))
                                        }
                                    </ul>
                                </div>
            ...
            {
                isVisible &&
                <Link href='#'><a onClick={scrollToTop}  id="scroll-top"></a></Link>
            }
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body space-y-20 pd-40">
                            ...
                            <Link href="#"><a className="btn btn-primary" data-toggle="modal" data-target="#popup_bid_success" data-dismiss="modal" aria-label="Close">Place a bid</a></Link>
                        </div>
                    </div>
                </div>
            </div>
